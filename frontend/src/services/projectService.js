...
export const assignProject = ({ project_id, business_id }) => {
   return httpService.put('api/admin/project/assign', { project_id, business_id })
}
...
export const checkTotalFileSizeOfUser = (projectId, data) => {
   return httpService.post('api/project/' + projectId + '/check-file-size', data)
}
