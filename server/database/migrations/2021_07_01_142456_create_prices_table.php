...
class CreatePricesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('prices', function (Blueprint $table) {
            ...
            $table->integer('main_amount', 8, 1)->nullable();
            $table->string('main_unit', 10)->nullable();
            $table->integer('add_amount', 8, 1)->nullable();
            $table->string('add_unit', 10)->nullable();
            $table->integer('main_period', 8, 1)->nullable();
            $table->string('main_period_unit', 10)->nullable();
            $table->integer('add_period', 8, 1)->nullable();
