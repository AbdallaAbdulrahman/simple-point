            ...
            <Card login className={classes[cardAnimaton]}>
              ...
              <CardBody>
                <form>
                  ...
                  <div>
                    <a href="/auth/login" rel={"noindex nofollow"}><span style={{ float:"left" }} rel={"noindex nofollow"}><i className="fa fa-angle-left" style={{ width: "15px", height: "15px" }}></i>ログインページに戻る	
</span></a>
                    <Button style={{ backgroundColor: "#e12e3e", float: "right" }} onClick={registerClick}>
                      <b>登録する</b>
                    </Button>
                  </div>
                </form>
