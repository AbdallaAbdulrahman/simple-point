...
class CreateProjectDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('project_details', function (Blueprint $table) {
            ...
            $table->float('ground_data_price', 10, 1)->nullable();
            $table->float('simplified_drawing_price', 10, 1)->nullable();
            $table->float('contour_price', 10, 1)->nullable();
            $table->float('longitudinal_price', 10, 1)->nullable();
            $table->float('simple_orthphoto_price', 10, 1)->nullable();
            $table->float('mesh_soil_volume_price', 10, 1)->nullable();
            $table->float('simple_accuracy_price', 10, 1)->nullable();
            $table->float('public_accuracy_price', 10, 1)->nullable();
