  ...
  return (
    <div className={classes.topbar}>
      ...
      <div className={classes.alignRight}>
        <a href="/auth/login" style={{ color: "#e12e3e" }} rel={"noindex nofollow"}>
          <Button1
        ...
        <a href="/auth/register" style={{ color: "white" }} rel={"noindex nofollow"}>
          <Button1 style={{ backgroundColor: "#e12e3e", border: "1px solid #e12e3e" }}>
            会員登録
          </Button1>
        </a>
