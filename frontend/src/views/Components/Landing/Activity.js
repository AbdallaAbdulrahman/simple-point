  ...
  return (
    <div style={{ padding: "80px 10%" }} id={id}>
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "16px", color: "#e12e3e" }}><b>活⽤例</b></p>
            ...
            <GridItem xs={12} sm={3}>
              <div style={{ position: "relative", textAlign: "center",
               color: "white", fontSize: "20px"}} >
                ...
                <div style={{ position: "absolute", top: "47%", left: "45%"}}><b>測量</b></div>
              </div>
            </GridItem>
            <GridItem xs={12} sm={3}>
              <div style={{ position: "relative", textAlign: "center",
               color: "white", fontSize: "20px"}} >
                ...
                <div style={{ position: "absolute", top: "47%", left: "45%"}}><b>設計</b></div>
              </div>
            </GridItem>
            <GridItem xs={12} sm={3}>
              <div style={{ position: "relative", textAlign: "center",
               color: "white", fontSize: "20px"}} >
                ...
                <div style={{ position: "absolute", top: "47%", left: "45%"}}><b>建設</b></div>
              </div>
            </GridItem>
            <GridItem xs={12} sm={3}>
              <div style={{ position: "relative", textAlign: "center",
               color: "white", fontSize: "20px"}} >
                ...
                <div style={{ position: "absolute", top: "47%", left: "45%"}}><b>建築</b></div>
              </div>
            </GridItem>
        </GridContainer>
    </div>
